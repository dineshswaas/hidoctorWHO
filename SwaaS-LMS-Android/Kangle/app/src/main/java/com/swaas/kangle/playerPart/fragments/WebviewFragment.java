...
import com.swaas.kangle.playerPart.customviews.webview.MyCustomWebview;
...
public class WebviewFragment extends Fragment implements OnSingleTapImage {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ViewGroup view = (ViewGroup) inflater.inflate(R.layout.fragment_webview_fragment, container, false);
