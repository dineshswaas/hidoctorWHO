...
import com.swaas.kangle.DigitalAssetPlayer.customviews.image.TouchImageView;
...
public class ImageViewFragment extends Fragment implements OnSingleTapImage, View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        ...
        ViewGroup view = (ViewGroup) inflater.inflate(R.layout.fragment_asset_image_view,container,false);
