...
/**
 * Created by Dinesh on 20-06-2019.
 */

public class SurveyListAdapter extends RecyclerView.Adapter<SurveyListAdapter.CheckListRecyclerHolder>{
    ...
    public SurveyListAdapter(Context context, List<CheckListModel> courseModels) {
