...
import static com.swaas.kangle.playerPart.customviews.pdf.util.Constants.Pinch.MAXIMUM_ZOOM;
import static com.swaas.kangle.playerPart.customviews.pdf.util.Constants.Pinch.MINIMUM_ZOOM;
...
//       return retVal;
    ...
    SimpleTwoFingerDoubleTapDetector multiTouchListener = new SimpleTwoFingerDoubleTapDetector() {
        ...
        public void onTwoFingerDoubleTap() {
            ...
            if (onSingleTapTouchListener != null){
                onSingleTapTouchListener.onTwoFingerDoubleTouch();
            }
        }
    };
