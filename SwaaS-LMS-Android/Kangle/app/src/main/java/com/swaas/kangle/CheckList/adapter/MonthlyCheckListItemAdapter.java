...
public class MonthlyCheckListItemAdapter extends RecyclerView.Adapter<MonthlyCheckListItemAdapter.CheckListRecyclerHolder>{
    ...
    public MonthlyCheckListItemAdapter(Context context, List<CheckListModel> courseModels) {
    ...
    public void onBindViewHolder(CheckListRecyclerHolder holder, int position) {
        ...
        if(courseModel.getChecklist_Status_Value() == Constants.COMPLETED){
            ...
            holder.mCourseEndTime.setTextColor(context.getResources().getColor(R.color.black));
        }

        holder.typeofChklist.setText("M");
