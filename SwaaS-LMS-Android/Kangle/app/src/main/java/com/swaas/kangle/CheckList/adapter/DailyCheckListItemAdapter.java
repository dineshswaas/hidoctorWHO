...
public class DailyCheckListItemAdapter extends RecyclerView.Adapter<DailyCheckListItemAdapter.CheckListRecyclerHolder>{
    ...
    public DailyCheckListItemAdapter(Context context, List<CheckListModel> courseModels) {
    ...
    public void onBindViewHolder(CheckListRecyclerHolder holder, int position) {
        ...
        holder.typeofChklist.setText("D");
