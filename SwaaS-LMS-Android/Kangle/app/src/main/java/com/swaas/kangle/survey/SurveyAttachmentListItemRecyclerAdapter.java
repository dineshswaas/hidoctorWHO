...
public class SurveyAttachmentListItemRecyclerAdapter extends RecyclerView.Adapter<SurveyAttachmentListItemRecyclerAdapter.ViewHolder>  {

    SurveyQuestionDetailsActivity mActivity;
    CreateTaskActivity createTaskActivity;
    List<Acknowledgement_urls> mAcknowledgement_urls;
    boolean a=false;
    View view;

    public SurveyAttachmentListItemRecyclerAdapter(SurveyQuestionDetailsActivity activity, List<Acknowledgement_urls> acknowledgement_urlses)  {
        mActivity =  activity;
        mAcknowledgement_urls = acknowledgement_urlses;
    }

    public SurveyAttachmentListItemRecyclerAdapter(CreateTaskActivity createTaskActivity1, ArrayList<Acknowledgement_urls> urls, boolean b) {
