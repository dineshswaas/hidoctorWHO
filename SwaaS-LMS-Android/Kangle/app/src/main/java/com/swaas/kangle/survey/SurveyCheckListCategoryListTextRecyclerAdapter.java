...
public class SurveyCheckListCategoryListTextRecyclerAdapter extends RecyclerView.Adapter<SurveyCheckListCategoryListTextRecyclerAdapter.ViewHolder>{

    SurveyListActivity mActivity;
    List<CheckListModel> cat;

    public SurveyCheckListCategoryListTextRecyclerAdapter(Context context, List<CheckListModel> categoryList)  {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        return new SurveyCheckListCategoryListTextRecyclerAdapter.ViewHolder(view);
    }
