...
package com.swaas.kangle.DigitalAssetPlayer.customviews.pdf;
...
import com.swaas.kangle.DigitalAssetPlayer.customviews.pdf.listener.OnDrawListener;
import com.swaas.kangle.DigitalAssetPlayer.customviews.pdf.listener.OnErrorListener;
...
import com.swaas.kangle.DigitalAssetPlayer.customviews.pdf.listener.OnPageScrollListener;
import com.swaas.kangle.DigitalAssetPlayer.customviews.pdf.listener.OnRenderListener;
...
import com.swaas.kangle.DigitalAssetPlayer.customviews.pdf.model.PagePart;
import com.swaas.kangle.DigitalAssetPlayer.customviews.pdf.scroll.ScrollHandle;
import com.swaas.kangle.DigitalAssetPlayer.customviews.pdf.source.AssetSource;
import com.swaas.kangle.DigitalAssetPlayer.customviews.pdf.source.ByteArraySource;
import com.swaas.kangle.DigitalAssetPlayer.customviews.pdf.source.DocumentSource;
import com.swaas.kangle.DigitalAssetPlayer.customviews.pdf.source.FileSource;
import com.swaas.kangle.DigitalAssetPlayer.customviews.pdf.source.InputStreamSource;
import com.swaas.kangle.DigitalAssetPlayer.customviews.pdf.source.UriSource;
import com.swaas.kangle.DigitalAssetPlayer.customviews.pdf.util.ArrayUtils;
import com.swaas.kangle.DigitalAssetPlayer.customviews.pdf.util.Constants;
import com.swaas.kangle.DigitalAssetPlayer.customviews.pdf.util.MathUtils;
...
public class PDFView extends RelativeLayout {
   ...
   public ScrollHandle getScrollHandle() {
    ...
    public OnSingleTapTouchListener onsingletap;
    ...
    public PdfSwipeUpDownListener pdfSwipeUpDownListener;
    ...
    private void load(DocumentSource docSource, String password, OnLoadCompleteListener onLoadCompleteListener, OnErrorListener onErrorListener, int[] userPages) {
        ...
        if (originalUserPages != null) {
            ...
            dragPinchManager.setIsSinglePageViewer(true);
    ...
    public void setListenerForSinglePage(PdfSwipeUpDownListener pdfSwipeUpDownListener){

        this.pdfSwipeUpDownListener = pdfSwipeUpDownListener;
    ...
    void showPage(int pageNb) {
        ...
        if (onPageChangeListener != null&&originalUserPages == null) {
    ...
    public void enableSingletap(OnSingleTapTouchListener onSingleTapTouchListener){
        ...
        this.dragPinchManager.enableSingletap(onSingleTapTouchListener);
    }
    ...
    public class Configurator {
        ...
        public Configurator enableSingletap(OnSingleTapTouchListener onsingletaptouch) {
            onsingletap = onsingletaptouch;
            return this;
        }
