...
public class DigitalAssetPlayerActivity extends AppCompatActivity implements View.OnClickListener,
        ViewPager.OnPageChangeListener, OnAssetChangeListener, OnAssetListPlayerItemClicked,
        MyAssetPlayerViewPager.OnSwipeOutListener, PopupMenu.OnMenuItemClickListener {
    ...
    private TextView mAssetGotItTipTextview,mAssetListCrossButton;
    ...
    private TextView mBtn_GestureOverlay_Close,mBtn_GestureOverlay_Closeview,mAssetName;
    public int CurrentGesturePosition;
    private ImageView mGestureImage;
    private int CourseId, PublishId, SectionId;
    ImageView rating1_img, rating2_img, rating3_img, rating4_img, rating5_img;
    Handler handler;
    int like_rating;
    public LinearLayout mTransparentView, mAssetListHolder;
    public ImageView mIcDrawerOpenLayout,showActionBarImage;
...
//    }
    ...
    private void ViewInialization() {
        ...
        if(CourseId > 0){
            ...
            mIcDrawerOpenLayout.setVisibility(View.VISIBLE);
        }else{
            mIcDrawerOpenLayout.setVisibility(View.GONE);
        }
    ...
    private void getDigitalAssetList() {
        ...
        if (getIntent() != null) {
            ...
            if(CourseId == 0){
                digitalAssetsList.get(0).setPreviewSessionId(mDigitalAssetRepository.getAssetSessionId(digitalAssetsList.get(0).getDA_Code(),CourseId,SectionId));
            }
        }
    ...
    private void UpdateFeedback(DigitalAssets digitalAssets, int likeoption) {
        ...
        digitalAssetsforfeedback.setCourse_Id(CourseId);
        digitalAssetsforfeedback.setSection_Id(SectionId);
        digitalAssetsforfeedback.setUser_Id(PreferenceUtils.getUserId(this));
    ...
    public void onAssetChanged(int position) {
        ...
        mAssetName.setText(mCurrentAssetObject.getAsset_Name());
    }


    public int getCurrentSessionId(int currentAssetPosition) {
        Log.d("parm sessionId",String.valueOf(mDigitalAssetRepository.getAssetSessionId(digitalAssetsList.get(currentAssetPosition).getDA_Code(),CourseId,SectionId)));
    ...
    public boolean InsertEdetailStarttime(Date edetailstarttime, int SessionId, int currentAssetPosition) {
        ...
        Log.d("pammm",String.valueOf(getCurrentSessionId(currentAssetPosition)+1));
        return true;
    }
