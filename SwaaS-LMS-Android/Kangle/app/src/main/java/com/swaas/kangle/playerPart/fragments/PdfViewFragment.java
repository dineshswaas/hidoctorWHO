...
import com.swaas.kangle.playerPart.pdfasync.DownloadPdfAysnc;
import com.swaas.kangle.playerPart.pdfasync.OnPdfDownload;
...
public class PdfViewFragment extends Fragment implements OnPdfDownload, OnPageChangeListener, OnLoadCompleteListener, OnSingleTapTouchListener, View.OnClickListener, PdfSwipeUpDownListener {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        ...
        ViewGroup view = (ViewGroup) inflater.inflate(R.layout.fragment_pdf_viewer,container,false);
