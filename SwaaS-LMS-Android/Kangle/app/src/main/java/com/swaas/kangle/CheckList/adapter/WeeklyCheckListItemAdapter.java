...
public class WeeklyCheckListItemAdapter extends RecyclerView.Adapter<WeeklyCheckListItemAdapter.CheckListRecyclerHolder>{
    ...
    public WeeklyCheckListItemAdapter(Context context, List<CheckListModel> courseModels) {
    ...
    public void onBindViewHolder(CheckListRecyclerHolder holder, int position) {
        ...
        holder.typeofChklist.setText("W");
