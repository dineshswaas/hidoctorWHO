...
public class CheckListTagsListTextRecyclerAdapter extends RecyclerView.Adapter<CheckListTagsListTextRecyclerAdapter.ViewHolder>{

    CheckListListActivity mActivity;
    List<CheckListModel> cat;

    public CheckListTagsListTextRecyclerAdapter(Context context, List<CheckListModel> categoryList)  {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        return new CheckListTagsListTextRecyclerAdapter.ViewHolder(view);
    }
