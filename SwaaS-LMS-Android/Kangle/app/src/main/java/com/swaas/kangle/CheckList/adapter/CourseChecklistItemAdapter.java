...
public class CourseChecklistItemAdapter extends RecyclerView.Adapter<CourseChecklistItemAdapter.CheckListRecyclerHolder>{
    ...
    public CourseChecklistItemAdapter(Context context, List<CheckListModel> courseModels) {
    ...
    public void onBindViewHolder(CheckListRecyclerHolder holder, int position) {
        ...
        holder.mTitle.setText(courseModel.getChecklist_Name());
        holder.mThumbnail.setVisibility(View.VISIBLE);
        holder.defaultthumbnailview.setVisibility(View.GONE);
        Ion.with(holder.mThumbnail).placeholder(R.drawable.icon_checklist_default).error(R.drawable.icon_checklist_default).load(
        ...
        if(courseModel.getChecklist_Status_Value() == Constants.COMPLETED){
            ...
            holder.mCourseEndTime.setTextColor(context.getResources().getColor(R.color.buttoncolor));
            ...
            holder.mCourseEndTime.setTextColor(Color.RED);
        } else {
            holder.mCourseEndTime.setText(courseModel.getValid_To());
            holder.mCourseEndTime.setTextColor(context.getResources().getColor(R.color.white));
        }
        ...
        holder.mCourseEndTime.setVisibility(View.GONE);
    }
