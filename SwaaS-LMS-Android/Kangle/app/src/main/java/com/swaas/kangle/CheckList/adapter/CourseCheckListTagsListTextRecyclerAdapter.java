...
public class CourseCheckListTagsListTextRecyclerAdapter extends RecyclerView.Adapter<CourseCheckListTagsListTextRecyclerAdapter.ViewHolder>{

    CourseChecklistListActivity mActivity;
    List<CheckListModel> cat;

    public CourseCheckListTagsListTextRecyclerAdapter(Context context, List<CheckListModel> categoryList)  {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        return new CourseCheckListTagsListTextRecyclerAdapter.ViewHolder(view);
    }
