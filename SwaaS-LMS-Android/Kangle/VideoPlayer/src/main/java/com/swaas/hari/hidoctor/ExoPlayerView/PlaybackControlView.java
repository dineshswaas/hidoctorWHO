...
import com.swaas.hari.hidoctor.R;
...
public class PlaybackControlView extends FrameLayout {
  ...
  public SeekbarChangedListener seekchange;
  public  boolean isFromAudio = false;
  private Context mContext;

  public void setSeekchangeListener(SeekbarChangedListener mseekbarchangelistener) {

    seekchange = mseekbarchangelistener;

  }

  public void setIsFromAudio(boolean isfromAudio) {
  ...
  public void setupLanscapeIcon() {

     ImageButton playimg = (ImageButton) playButton;
     ImageButton pauseimg = (ImageButton) pauseButton;
     ImageButton previousimg = (ImageButton) previousButton;
     ImageButton nextimg = (ImageButton) nextButton;
     ImageButton backwardimg = (ImageButton) rewindButton;
     ImageButton farwardimg = (ImageButton) fastForwardButton;

    playimg.setImageResource(R.mipmap.ic_play_land);
    pauseimg.setImageResource(R.mipmap.ic_pause_land);
    previousimg.setImageResource(R.mipmap.ic_previous_land);
    nextimg.setImageResource(R.mipmap.ic_next_land);
    backwardimg.setImageResource(R.mipmap.ic_backward_land);
    farwardimg.setImageResource(R.mipmap.ic_forward_land);



  }

  public void  setUpPortraitIcon() {
    ...
    playimg.setImageResource(R.mipmap.ic_play);
    pauseimg.setImageResource(R.mipmap.ic_pause);
    previousimg.setImageResource(R.mipmap.ic_previous);
    nextimg.setImageResource(R.mipmap.ic_next);
    backwardimg.setImageResource(R.mipmap.ic_backward);
    farwardimg.setImageResource(R.mipmap.ic_forward);
  ...
  private final class ComponentListener implements ExoPlayer.EventListener, TimeBar.OnScrubListener,
    ...
    public void onScrubStart(TimeBar timeBar, long position) {
      long startposition = position/1000;
      Log.d("=>Start",""+startposition);
      if (seekchange!=null){
        seekchange.onStartSeek(startposition);
      }
      removeCallbacks(hideAction);
      scrubbing = true;
    }
    ...
    public void onScrubStop(TimeBar timeBar, long position, boolean canceled) {
      scrubbing = false;
      long endposition = position/1000;
      Log.d("=>end",""+endposition);
      if (seekchange!=null){
        seekchange.onStopSeek(endposition);
      }
      ...
      if (player != null) {
        if (nextButton == view) {
         ...
         // next();
          ...
          if (seekchange!=null){
            seekchange.onNextTenClicked();
          }
          fastForward();
        } else if (rewindButton == view) {
          if (seekchange!=null){
            seekchange.onPreviousTenClicked();
          }
          rewind();
        } else if (playButton == view) {
          controlDispatcher.dispatchSetPlayWhenReady(player, true);
          if (seekchange!=null){
            seekchange.onPlayClicked();
          }
        } else if (pauseButton == view) {

          controlDispatcher.dispatchSetPlayWhenReady(player, false);
          if (seekchange!=null){
            seekchange.onPauseClicked();
          }
        }
      }
      hideAfterTimeout();
