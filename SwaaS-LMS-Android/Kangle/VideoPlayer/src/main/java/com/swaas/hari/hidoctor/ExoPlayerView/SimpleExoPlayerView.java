...
import com.swaas.hari.hidoctor.ExoPlayerView.text.Cue;
...
import com.swaas.hari.hidoctor.ExoPlayerView.AspectRatioFrameLayout.ResizeMode;
import com.swaas.hari.hidoctor.ExoPlayerView.PlaybackControlView.ControlDispatcher;
...
public final class SimpleExoPlayerView extends FrameLayout {
  ...
  public SeekbarChangedListener mseekbarchangelistener;
  ...
  public void setControllerListner(SeekbarChangedListener seekbarChangedListener){
    this.mseekbarchangelistener = seekbarChangedListener;

    if (controller!=null){

      controller.setSeekchangeListener(mseekbarchangelistener);
  ...
  private static void setResizeModeRaw(AspectRatioFrameLayout aspectRatioFrame, int resizeMode) {
    ...
    public void setIsFromAudio(boolean isfromAudio) {
      ...
      controller.setIsFromAudio(isfromAudio);
      controller.show();
